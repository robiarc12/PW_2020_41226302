...
<body>
    ...
    <div class="card mt-10 mb-100" style="width: 18rem;">
        ...
        <div class="card-body">
            <a href="hapus.php?id=<?= $mahasiswa['id'] ?>" class="card-link btn btn-danger"
                onclick="return confirm('yakin hapus data?')">Hapus</a>
            <a href="ubah.php?id=<?= $mahasiswa['id'] ?>" class="card-link btn btn-success">Ubah</a>
        </div>
        <button type="button" class="btn btn-primary"><a href="index.php">Kembali Ke Halaman Utama</a></button>
    </div>
</body>
